...
/**
 * Servlet implementation class TeacherProfileController
 */
...
public class TeacherProfileController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (acc_cur == null) {
			...
			request.getRequestDispatcher("WEB-INF/view/teacher/teacher_profile.jsp").forward(request, response);
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "WEB-INF/view/teacher/teacher_profile.jsp";
		String message = "";
