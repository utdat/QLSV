...
ArrayList<SubjectGroup> sg_list = (ArrayList<SubjectGroup>) session.getAttribute("sg_list");
...
<%
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
		...
		<header class="w3-container" style="padding-top: 22px">
			<h2>
				<b><i class="fas fa-shapes"></i> Subject Group List</b>
			</h2>
		</header>
		<div class="panel-body">
			<div class="input-group">
				<input class="form-control" type="text"
					placeholder="Search for subject group..." id="myInput"
				...
				<table id="table" class="w3-table-all w3-hoverable" cellpadding="0"
					...
					<thead>
						...
						<tr>
							...
							<td><select class="form-control" name="dep_id" required>
						...
						%>
						<tr>
							<td class="w3-center"><%=sg_list.get(i).getId()%></td>
							<td class="w3-center"><%=sg_list.get(i).getName()%></td>
							<td><%=dep_map.get(sg_list.get(i).getDep_id())%></td>
							<td class="w3-center"><a href="AdminSubGroup?action=delete&sg_id=<%=sg_list.get(i).getId()%>"><i
